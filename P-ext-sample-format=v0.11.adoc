...
=== PSH!ADD.H – Shift Left by One and Add
...
*Purpose:* Shift left by 1 and add.

*Description:* This instruction shifts Rs1 to the left by 1 bit and adds
it to Rs2, then writes the result to Rd.
...
|===
|Name |Prototype
|__riscv_psh1add_h |int16x2_t __riscv_psh1add_h(int16x2_t rs1, int16x2_t
rs2);
|===
